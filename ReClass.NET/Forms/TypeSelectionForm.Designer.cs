...
namespace ReClassNET.Forms
{
	partial class TypeSelectionForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.bannerBox.Text = "Select a type.";
			this.bannerBox.Title = "Type Selection";
			//
			// classesListBox
			//
			this.typesListBox.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
            | System.Windows.Forms.AnchorStyles.Left)
            | System.Windows.Forms.AnchorStyles.Right)));
			this.typesListBox.DisplayMember = "Name";
			this.typesListBox.FormattingEnabled = true;
			this.typesListBox.Location = new System.Drawing.Point(12, 80);
			this.typesListBox.Name = "typesListBox";
			this.typesListBox.Size = new System.Drawing.Size(492, 186);
			this.typesListBox.TabIndex = 2;
			this.typesListBox.SelectedIndexChanged += new System.EventHandler(this.classesListBox_SelectedIndexChanged);
			this.typesListBox.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.classesListBox_MouseDoubleClick);
			//
			// filterNameTextBox
			//
			...
			this.filterNameTextBox.PlaceholderText = "Filter by Type Name...";
			...
			this.Text = "ReClass.NET - Type Selection";
